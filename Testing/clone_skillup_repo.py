...
repo_url = "https://github.com/mtp1032/SkillUp.git"
...
with tempfile.TemporaryDirectory() as temp_dir:
    ...
    for target_dir in target_directories:
        # Define the path to the SkillUp subdirectory
        metrics_dir = os.path.join(target_dir, "SkillUp")
        ...
        # Remove existing non-Git files in the SkillUp directory
        ...
        # Copy the contents of the cloned repository to the SkillUp directory,
